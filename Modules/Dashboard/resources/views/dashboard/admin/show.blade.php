...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header cursor-pointer">
            ...
            @if($admin->id !== auth()->id())
                <a href="{{ route('dashboard.admins.edit', [$admin->id]) }}" class="btn btn-primary align-self-center">
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-4 fw-bold text-muted">
                    {{ __('dashboard::dashboard.username') }}
                </label>
                <!--end::Label-->
                <!--begin::Col-->
            ...
            <div class="row mb-10">
                ...
                <!--begin::Label-->
                <!--begin::Label-->
                <div class="col-lg-8" title="{{ $admin->updated_at }}">
