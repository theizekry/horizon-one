...
{{--        <!--end::Heading-->--}}
        ...
        <div class="fv-row fv-plugins-icon-container">
            ...
            <div class="row">
                <!--begin::Col-->
                <div class="col-lg-12" v-if="currentStep === 2">
                    <div class="fv-row mb-10">
                        <label class="required form-label">Oauth Scope</label>
                        <input type="text" class="form-control" name="oauth_scope" placeholder="Enter client name"/>
